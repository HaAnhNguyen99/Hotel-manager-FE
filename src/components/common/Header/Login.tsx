  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button
          variant="outline"
          className="hover:bg-black hover:opacity-80 hover:text-white hover:scale-x-105 transition-all duration-300 ease-in-out font-semibold text-black dark:text-white dark:border dark:border-white">
          Đăng nhập
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription className="text-center text-sm font-light">Đăng nhập để trải nghiệm trang web</DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-4 py-4">
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className="flex items-center justify-between rounded-lg ring-1 ring-zinc-200 shadow-sm p-2 px-3 transition-all duration-300 ease-in-out hover:ring-zinc-600 hover:opacity-80 hover:scale-x-105">
                      ...
                      />
                      {fieldState.isDirty && !fieldState.error && <BadgeCheck size={18} color="#30A167" />}
                    </div>
                  </FormControl>
                  <FormMessage />
                </FormItem>
                  ...
                  <FormControl>
                    <div className="flex items-center justify-between rounded-lg ring-1 ring-zinc-200 shadow-sm p-2 px-3 transition-all duration-300 ease-in-out hover:ring-zinc-600 hover:opacity-80 hover:scale-x-105">
                      ...
                      <button
                        ...
                        {isPeak ? <Eye size={18} color="black" /> : <EyeOff size={18} color="black" />}
                      </button>
                    </div>
                  </FormControl>
                  <FormMessage />
            ...
            <div className="flex justify-between">
              <div className="flex items-center gap-1">
                ...
                />
                <label htmlFor="terms" className="text-sm font-light leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                  Ghi nhớ
                </label>
              </div>
              <Link
