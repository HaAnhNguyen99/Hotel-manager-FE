      ...
      <div className="space-y-2 mt-2">
        <div className="flex justify-between items-center ">
          <div className="flex gap-2 h-full items-center">
            <div className="h-full w-1 rounded-[7rem] flex-shrink-0 bg-[#ffe99a] min-h-12"></div>
            <div>
          ...
          <div className="text-black px-2 p-2 tracking-tight font-bold bg-gray-200 rounded-lg text-xl">{Ratio.cashRatio}%</div>
        </div>

        <div className="flex justify-between items-center">
          <div className="flex gap-2 h-full items-center">
            <div className="h-full w-1 rounded-[7rem] flex-shrink-0  min-h-12 bg-[#b490ac]"></div>
            <div>
          ...
          <div className="text-black px-2 p-2 tracking-tight font-bold bg-gray-200 rounded-lg text-xl">{Ratio.bankingRatio}%</div>
        </div>
      </div>
    </div>
  );
