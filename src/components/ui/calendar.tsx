  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_next:
          "absolute right-1 text-black dark:text-white dark:bg-zinc-700",
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 dark:text-zinc-400"
        ),
        day_range_start: "day-range-start",
        day_range_end: "day-range-end",
        day_selected:
          "bg-zinc-900 text-zinc-50 hover:bg-zinc-900 hover:text-zinc-50 focus:bg-zinc-900 focus:text-zinc-50 dark:bg-zinc-50 dark:text-zinc-400 dark:hover:bg-zinc-50 dark:hover:text-zinc-900 dark:focus:bg-zinc-50 dark:focus:text-zinc-400 dark:text-black hover:dark:text-zinc-400",
        day_today: " text-slate-400 dark:bg-zinc-600 dark:text-zinc-50",
        day_outside:
      ...
      components={{
        IconLeft: ({ className, ...props }) => (
          <ChevronLeft
            className={cn("h-4 w-4 dark:text-white", className)}
            {...props}
          />
        ),
